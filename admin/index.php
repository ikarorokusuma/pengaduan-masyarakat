			...
			<ul id="slide-out" class="sidenav sidenav-fixed">
				<li>
					<div class="user-view">
						...
						<a href="#name">
							<span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></sp>
						</a>
					</div>
				</li>
				...
				<li><a href="index.php?p=user"><i class="material-icons">account_box</i>Akun Pengguna</a></li>
